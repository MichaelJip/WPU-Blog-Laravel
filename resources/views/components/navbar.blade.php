                     ...
                     <div class="relative ml-3">
                             ...
                             @if (Auth::check())
                                 <button type="button" @click="isOpen = !isOpen"
                                     ...
                                     <img class="size-8 rounded-full"
                                         ...
                                         alt="">
                                     <div class="text-gray-300 mx-4 font-medium">{{ Auth::user()->name }}</div>
                                 </button>
                             @else
                                 <a href="/login" class="text-white test-sm font-medium">Login</a>
                                 <span class="text-white">|</span>
                                 <a href="/register" class="text-white test-sm font-medium">Register</a>
                             @endif
                         </div>
                         ...
                         <div x-show="isOpen" x-transition:enter="transition ease-out duration-100 transform"
                             ...
                             <form method="POST" action="/logout">
                                 @csrf
                                 <button class="block px-4 py-2 text-sm text-gray-700 cursor-pointer" role="menuitem"
                                     tabindex="-1" id="user-menu-item-2" type="submit">Log out</button>
                             </form>
                         </div>
                     </div>
                 </div>
